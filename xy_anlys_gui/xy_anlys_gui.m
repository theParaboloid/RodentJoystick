...
try
    ...
    lick_on = jstruct(struct_index).lick_on; %saumya
catch
end
...
lickon_vect = zeros(1,length(traj_x)); %saumya
...
plotdata = [np_vect; js_vect_l; js_vect_r; rw_vect; laser_vect; ...%saumya
...
function np4_Callback(hObject, eventdata, handles)
    ...
    guidata(hObject, handles);%saumya
